...
const SearchBar = () => {
  ...
  return (
    <div className="flex sm:w-[23rem] font-openSans bg-white">
      <div className="w-[100%] flex items-center gap-[.1rem] border-2 h-[2.5rem] px-[1rem] rounded-[.5rem] ">
        <IoSearch className="text-[1.2rem] text-gray-400" />
        <Input
          value={searchText}
